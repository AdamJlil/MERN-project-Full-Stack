    ...
    return ( 
        <header className="w-full">
            <div className="container mx-auto">
                ...
                <nav class="bg-white w-full border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="/" class="flex items-center">
       
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Work It Out</span>
    </a>
